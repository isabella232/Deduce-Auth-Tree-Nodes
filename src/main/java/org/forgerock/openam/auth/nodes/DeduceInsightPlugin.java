 ...
 * @since AM 5.5.0
 */
public class DeduceInsightPlugin extends AbstractNodeAmPlugin {
    ...
    protected Map<String, Iterable<? extends Class<? extends Node>>> getNodesByVersion() {
        return Collections.singletonMap(DeduceInsightPlugin.currentVersion,
                                        Arrays.asList(DeduceInsightNode.class, DeduceBooleanNode.class,
                                                      DeduceScoreNode.class, DeduceSignalNode.class,
                                                      DeduceStringNode.class));
    }
    ...
    public String getPluginVersion() {
        return DeduceInsightPlugin.currentVersion;
    }
}
